...
import {
  PRODUCT_CARD_CART_FIGMA_ICON_HEIGHT_PX,
  PRODUCT_CARD_CART_FIGMA_ICON_WIDTH_PX,
...
/** Figma node 101:3553 — white cart icon inside the yellow circle. */
export function ProductCardCartFigmaIcon() {
  ...
  return (
    <svg
      ...
      style={{
        width: PRODUCT_CARD_CART_FIGMA_ICON_WIDTH_PX,
        height: PRODUCT_CARD_CART_FIGMA_ICON_HEIGHT_PX,
      }}
      viewBox="0 0 25 26"
      fill="none"
