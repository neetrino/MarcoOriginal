...
export const HOME_TITLE_TO_RAIL_GAP_PX = 59;
export const HOME_SPECIAL_OFFERS_TITLE_INSET_LEFT_PX = 17;
export const HOME_SPECIAL_OFFERS_TITLE_HIGHLIGHT_UNDERLINE_WIDTH_PERCENT = 48;
export const HOME_SPECIAL_OFFERS_TITLE_HIGHLIGHT_UNDERLINE_HEIGHT_PX = 4;
export const HOME_SPECIAL_OFFERS_TITLE_HIGHLIGHT_UNDERLINE_GAP_PX = 12;
export const HOME_SPECIAL_OFFERS_NAV_INSET_RIGHT_DESKTOP_PX = 32;
export const HOME_SPECIAL_OFFERS_NAV_INSET_RIGHT_MOBILE_PX = 32;

export const HOME_NAV_BUTTON_WIDTH_PX = 32;
export const HOME_NAV_BUTTON_HEIGHT_PX = 25;
