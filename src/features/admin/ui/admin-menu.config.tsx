...
export function getAdminMenuItems(locale: string): AdminMenuItem[] {
  ...
  const labels = getAdminCopy(locale).nav;
  ...
  return [
    {
      ...
      separatorAfter: true,
      icon: (
        <MenuIcon d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
      ),
    },
    {
      id: "dashboard",
    ...
    },
    {
      ...
      href: `${base}/analytics`,
      icon: <MenuIcon d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z M12 3v9h9" />,
    },
    {
      id: "delivery",
      ...
      href: `${base}/delivery`,
      icon: (
        <MenuIcon d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
      ),
    },
    {
      id: "blog",
...
export function isAdminTabActive(
  ...
  const storefrontHomeHref = `/${locale}`;
  if (tabHref === storefrontHomeHref) {
    return pathname === storefrontHomeHref || pathname === `${storefrontHomeHref}/`;
  }
