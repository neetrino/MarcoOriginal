...
describe("convertQuoteToBase", () => {
  ...
  it("inverts AMD to USD conversion", () => {
    expect(convertQuoteToBase(2600, "0.0026", "AMD", "USD")).toEqual({
      amount: 10_000n,
      currency: "AMD",
    });
  });

  it("inverts AMD to RUB conversion", () => {
    expect(convertQuoteToBase(24_000, "0.24", "AMD", "RUB")).toEqual({
      amount: 1_000n,
      currency: "AMD",
    });
  });
